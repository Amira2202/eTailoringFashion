...
<head>
    ...
    <style>
      ...
      z-index: -1; /* Set z-index to position behind other content */
        ...
        .product-container {
            display: grid;
            grid-template-columns: repeat(auto-fill, minmax(350px, 30fr)); /* Automatically adjust grid columns based on available space */
                        ...
                        while($row=$res->fetch_assoc()) {
                            echo  '
                                <div class="product-card">
                                    ...
                                    <p><a href="chudiview.php?id='. $row['pid'] .'" class="btn btn-success">View Details</a></p>
                                </div>
                            ';
                        }
                    }
